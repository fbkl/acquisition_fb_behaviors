...
class WaitForDiagsUserdata(EventState):
    '''
    ...
    def __init__(self, timeout=60):
        ...
        super(WaitForDiagsUserdata, self).__init__(outcomes = ['continue', 'failed'], input_keys=["diags_list"])

        # Store state parameter for later use.

        #self._initial_diags_len = len(self._diags_list)
        self._initial_diags_len = 0
    ...
    def on_enter(self, userdata):
        ...
        diags_list = userdata.diags_list
