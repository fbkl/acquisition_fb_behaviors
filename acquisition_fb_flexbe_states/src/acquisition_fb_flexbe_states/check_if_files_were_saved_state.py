...
class CheckFileSavedState(EventState):
    ...
    def __init__(self, filename_param = "rqt_acquisition/activity_name", dirname_param = "rqt_acquisition/save_path"):
    ...
    def execute(self, userdata):
        ...
        try:
            ...
            files_found = {}
            files_missing = []
            Logger.loginfo(f"dir: {self._dir}")
            Logger.loginfo(f"file: {repr(self._file)}")
